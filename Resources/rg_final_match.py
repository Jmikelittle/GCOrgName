...
matched_file = os.path.join(script_folder, 'Resources', 'rg_matched_names.csv')
fixed_file = os.path.join(script_folder, 'Resources', 'rg_fixed_names.csv')
...
# Identify new entries in 'rg_fixed_names.csv' based on 'gc_orgID'
...
# Merge 'rgnumber' field from 'rg_fixed_names.csv' to 'rg_final_match.csv'
...
updated_output_file = os.path.join(script_folder, 'Resources', 'rg_final_match.csv')
