...
receiver_general_file = os.path.join(script_folder, 'rg_receiver_general.csv')
manual_org_file = os.path.join(script_folder, 'rg_manual_org_id_link.csv')
rg_duplicates_file = os.path.join(script_folder, 'rg_duplicates.csv')
matched_file = os.path.join(script_folder, 'rg_matched_names.csv')
fixed_file = os.path.join(script_folder, 'rg_fixed_names.csv')
...
# Update rg_fixed_names.csv with new entries from rg_matched_names.csv
